import { winstonLogger } from '@engjellm2000/lib';
...
//mund te perdorim migrimet (migrations me ndonje librari per te eksportuar query kommanda ne databazen tone lokale)
